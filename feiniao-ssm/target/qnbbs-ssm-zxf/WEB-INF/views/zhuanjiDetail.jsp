...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/zhuanjiDetails.css"/>
		<style type="text/css">
			.search_input__input{
				position: relative;
				top: -85px;
		...
		<div class="mod_header">
		    <div class="section_inner">
		        ...
		        <!-- 导航 E -->
					...
					<p class="top_nav_VIP" ><a href="#"><span id="top_vip_color">开通飞鸟音乐VIP</span></a></p>
			...
			<section>
				<div class="container section">
					<div class="row" >
						...
						<div class="row">
							...
							<div class="row">
								<div class="col-md-8 h4 faxing_time">
									发行时间：<span>2020-08-05</span>
								</div>
							</div>
							<div class="row zhuan_btn">
								<div class="col-md-4 ">
									<div class="btn btn-default zhuanji_all_play_btn ">
										<img src="img/播放.png" class="zhuanji_all_play" >&nbsp;播放全部
									</div>
								</div>
								<div class="col-md-4 ">
						...
						<div class="col-md-9 singer_list">
							
							<table class="table" cellpadding="0" cellspacing="0">
								<thead >
									<tr >
										<th class="singer_list_th"></th>
										<th >歌曲</th>
										<th >歌手</th>
										<th >时长</th>
									</tr>
								</thead>
								<tbody class="singer_list_detail">
									<tr>
										<td>1</td>
										<td>平凡天使</td>
										<td>邓紫棋</td>
